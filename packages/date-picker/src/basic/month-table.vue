...
<script type="text/babel">
  ...
  import { isDate, range, getDayCountOfMonth, nextDate } from 'element-ui-fixing/src/utils/date-util';
  import { hasClass } from 'element-ui-fixing/src/utils/dom';
  import { arrayFindIndex, coerceTruthyValueToArray, arrayFind } from 'element-ui-fixing/src/utils/util';

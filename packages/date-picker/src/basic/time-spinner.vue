...
<script type="text/babel">
  import { getRangeHours, getRangeMinutes, modifyTime } from 'element-ui-fixing/src/utils/date-util';
  import ElScrollbar from 'element-ui-fixing/packages/scrollbar';
  import RepeatClick from 'element-ui-fixing/src/directives/repeat-click';

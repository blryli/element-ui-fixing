...
<script type="text/babel">
  ...
  import { isDate, range, nextDate, getDayCountOfYear } from 'element-ui-fixing/src/utils/date-util';
  import { arrayFindIndex, coerceTruthyValueToArray } from 'element-ui-fixing/src/utils/util';

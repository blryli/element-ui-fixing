<script>
  ...
  import ElButton from 'element-ui-fixing/packages/button';
  import ElButtonGroup from 'element-ui-fixing/packages/button-group';
  import { generateId } from 'element-ui-fixing/src/utils/util';

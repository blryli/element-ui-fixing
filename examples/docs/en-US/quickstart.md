...
import 'element-ui-fixing/lib/theme-chalk/index.css';
...
```javascript
import Vue from 'vue';
import { Button, Select } from 'element-ui-fixing';
import App from './App.vue';
...
```js
import Vue from 'vue';
import { Button } from 'element-ui-fixing';
